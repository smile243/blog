...
export const metadata: Metadata = {
  title: `推荐文章 | ${config.site.title}`,
  description: `推荐文章 of ${config.site.title}`,
  keywords: `${config.site.title}, featured blogs, ${config.site.title} featured blogs, nextjs blog template`,
};
